...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentBlock" runat="server">
    <table class="auto-style3">
        ...
        <tr>
            <td>
                <asp:TextBox ID="focusedCommentTxtBx" runat="server" Height="72px" TextMode="MultiLine" Width="590px">Write something in your mind...</asp:TextBox>
        ...
        <tr>
            <td class="auto-style4">
                <asp:Repeater ID="focusedContentCommentRepeater" runat="server">
                    <ItemTemplate>
                        ...
                        <br />    
                        <asp:Label ID="focusedContentCommentDateTime" runat="server" Text='<%# "Posted on " + Eval("createdAt") %>'></asp:Label>
                        <br />                    
                        <br />     
                    </ItemTemplate>
                </asp:Repeater>
