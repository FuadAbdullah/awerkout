...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentBlock" runat="server">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style7">
                <asp:DropDownList ID="userUsertypeDropDown" runat="server">
                </asp:DropDownList>
            </td>
            <td colspan="2" class="auto-style7">
        ...
        <tr>
            ...
            <td class="auto-style3">
                <asp:DropDownList ID="userAccountStatusDropDown" runat="server">
                </asp:DropDownList>
            </td>
            <td class="auto-style3" colspan="2">
        ...
        <tr>
            <td class="auto-style4">
                ...
                <asp:Button ID="userDeleteProfileBtn" runat="server" ForeColor="Red" OnClick="userDeleteProfileBtn_Click" Text="Delete Account" />
            </td>
            <td>
